...
class User extends Authenticatable implements HasMedia, MustVerifyEmail
{
    ...
    use BootableUuid, HasApiTokens, HasFactory, HasRoles, InteractsWithMedia, Notifiable, SoftDeletes;
    ...
    {
        return $this->hasMany(User::class, 'manager_email', 'email');
    }
    ...
    {
        return $this->hasOne(EmployeePosition::class)->where('is_current', true)->with('position', 'department');
    }

    public function positionHistory()
    {
        return $this->hasMany(EmployeePosition::class)->with('position', 'department')->orderBy('start_date', 'desc');
    }
