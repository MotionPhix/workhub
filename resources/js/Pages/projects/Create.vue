    ...
    <div class="max-w-4xl mx-auto">
      ...
      <div class="mb-8">
        ...
        <nav class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-4">
          ...
          <span class="text-gray-900 dark:text-white">Create Project</span>
        </nav>

        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Create New Project</h1>
        <p class="text-gray-600 dark:text-gray-400 mt-1">Set up a new project to organize and track your team's work</p>
      </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                Provide detailed information about the project scope and objectives
              </p>
            </div>
          </div>
        </div>
...
import { ArrowLeft, Calendar, Users, Target, Tag, Plus, X } from 'lucide-vue-next'
