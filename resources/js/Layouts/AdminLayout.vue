            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="relative">
                            <DropdownMenu>
                                <DropdownMenuTrigger as-child>
                                    <Button type="button" class="rounded-full size-6 flex items-center justify-center">
                ...
                <div class="md:hidden" v-show="showingNavigationDropdown">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('admin.invitations.index')" :active="route().current('admin.invitations.*')">
                            Invitations
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink :href="route('admin.insights.index')" :active="route().current('admin.insights.*')">
                            Insights
                        </ResponsiveNavLink>
                    </div>
                </div>
