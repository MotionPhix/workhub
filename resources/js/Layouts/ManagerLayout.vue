<template>
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
        <!-- Manager Navigation -->
        <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 shadow-xs">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center">
                        <Link :href="route('manager.dashboard')" class="flex items-center">
                            <h1 class="text-xl font-bold text-gray-900 dark:text-white">
                                {{ appName }} <span class="text-sm text-blue-500 dark:text-blue-400">Manager</span>
                            </h1>
                        </Link>
                    </div>
                ...
                <div class="md:hidden" v-show="showingNavigationDropdown">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('manager.work-entries.index')" :active="route().current('manager.work-entries.*')">
                            Work Entries
                        </ResponsiveNavLink>
